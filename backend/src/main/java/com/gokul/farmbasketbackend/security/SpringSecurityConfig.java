package com.gokul.farmbasketbackend.security;

import com.gokul.farmbasketbackend.security.Jwt.JwtEntryPoint;
import com.gokul.farmbasketbackend.security.Jwt.JwtFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/seller/product/new").access("hasAnyRole('ROLE_MANAGER')")
